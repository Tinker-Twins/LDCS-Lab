%% Exercise 1(A) - Additional Task 1
...
subplot(3,2,3);
lsim(System,u,t)
title('Ramp Response of Mechanical System');
xlabel('Time');
ylabel('Displacement');

% Parabolic response
u = (t.^2)/2; % Parabolic input
subplot(3,2,4);
lsim(System,u,t)
title('Parabolic Response of Mechanical System');
xlabel('Time');
ylabel('Displacement');

% Exponential response
u = exp(-t); % Exponential input
subplot(3,2,5);
lsim(System,u,t)
title('Exponential Response of Mechanical System');
xlabel('Time');
ylabel('Displacement');

% Sinusoidal response
u = sin(t); % Parabolic input
subplot(3,2,6);
lsim(System,u,t)
title('Sinusoidal Response of Mechanical System');
xlabel('Time');
ylabel('Displacement');
...
subplot(3,2,3);
lsim(System,u,t)
title('Ramp Response of Electrical System');
xlabel('Time');
ylabel('Voltage');
...
subplot(3,2,4);
lsim(System,u,t)
title('Parabolic Response of Electrical System');
xlabel('Time');
ylabel('Voltage');
...
subplot(3,2,5);
lsim(System,u,t)
title('Exponential Response of Electrical System');
xlabel('Time');
ylabel('Voltage');
...
subplot(3,2,6);
lsim(System,u,t)
title('Sinusoidal Response of Electrical System');
xlabel('Time');
ylabel('Voltage');
...
subplot(3,2,3);
lsim(System,u,t)
title('Ramp Response of Electromechanical System');
xlabel('Time');
ylabel('Angular Displacement');
...
subplot(3,2,4);
lsim(System,u,t)
title('Parabolic Response of Electromechanical System');
xlabel('Time');
ylabel('Angular Displacement');
...
subplot(3,2,5);
lsim(System,u,t)
title('Exponential Response of Electromechanical System');
xlabel('Time');
ylabel('Angular Displacement');
...
subplot(3,2,6);
lsim(System,u,t)
title('Sinusoidal Response of Electromechanical System');
xlabel('Time');
ylabel('Angular Displacement');